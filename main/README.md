...
│                         traffic_intelligent_platform and configuration for tools like black
│
...
│
└── traffic_intelligent_platform   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes traffic_intelligent_platform a Python module
    │
